...
{
    public class CactusBossHammer : MonoBehaviour
    {
        ...
        void Start()
        {
            _boss = GetComponentInParent<RenewCactusBoss>();
        ...
        IEnumerator InstantiateShockWaveAtCenter()
        {
            for (int i = 0; i < 3; i++)
            {
